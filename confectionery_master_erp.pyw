...
# ====================================================================
# 1. à¤¡à¥‡à¤Ÿà¤¾à¤¬à¥‡à¤¸ à¤‡à¤‚à¤œà¤¨ (Order Status Support & Dashboard Sync)
# ====================================================================
class ConfectioneryDB:
    ...
    def verify_and_use_coupon(self, code):
        ...
        row = cur.fetchone()
        if not row:
            return 0.0, "à¤…à¤®à¤¾à¤¨à¥à¤¯ à¤•à¥‚à¤ªà¤¨ à¤•à¥‹à¤¡!"
        if row[2] == 1:
            return 0.0, "à¤¯à¤¹ à¤•à¥‚à¤ªà¤¨ à¤ªà¤¹à¤²à¥‡ à¤¹à¥€ à¤‡à¤¸à¥à¤¤à¥‡à¤®à¤¾à¤² à¤•à¤¿à¤¯à¤¾ à¤œà¤¾ à¤šà¥à¤•à¤¾ à¤¹à¥ˆ!"
        
        cur.execute("UPDATE coupons SET is_used = 1 WHERE id = ?", (row[0],))
        self.conn.commit()
        return row[1], f"à¤¸à¤«à¤²! â‚¹{row[1]:.2f} à¤•à¥€ à¤›à¥‚à¤Ÿ à¤²à¤¾à¤—à¥‚ à¤¹à¥‹ à¤—à¤ˆà¥¤"
    ...
    def process_sale_with_gst(self, cust_phone, cust_name, pay_mode, items, redeem_points=0.0, earn_pct=1.0):
        ...
        if cust_phone and cust_phone != "WALK-IN":
            due_add = total_taxable_bill if pay_mode == "UDHARI (à¤‰à¤§à¤¾à¤°)" else 0.0
            cur.execute('''
                UPDATE customers 
...
# ====================================================================
# 2. à¤¸à¥‡à¤Ÿà¤…à¤ª à¤µà¤¿à¤œà¤¼à¤¾à¤°à¥à¤¡
# ====================================================================
class SetupWizardDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        lbl_title = QLabel("ðŸª WELCOME TO ERP SETUP", alignment=Qt.AlignmentFlag.AlignCenter)
        lbl_title.setFont(QFont("Segoe UI", 16, QFont.Weight.Bold))
        lbl_title.setStyleSheet("color: #005fb8; margin-bottom: 5px;")
        main_layout.addWidget(lbl_title)

        lbl_sub = QLabel("à¤…à¤ªà¤¨à¥‡ à¤µà¥à¤¯à¤µà¤¸à¤¾à¤¯ à¤•à¥€ à¤œà¤¾à¤¨à¤•à¤¾à¤°à¥€, à¤²à¥‹à¤—à¥‹ à¤”à¤° à¤à¤¡à¤®à¤¿à¤¨ à¤•à¥à¤°à¥‡à¤¡à¥‡à¤‚à¤¶à¤¿à¤¯à¤²à¥à¤¸ à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚:")
        ...
        self.txt_name.setPlaceholderText("Business Name (à¤‰à¤¦à¤¾. Ravi Confectionery)")
        ...
        self.btn_logo = QPushButton("ðŸ“ Upload Business Logo")
    ...
    def save_setup(self):
        ...
        if not name or not user or not pwd:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤µà¥à¤¯à¤µà¤¸à¤¾à¤¯ à¤•à¤¾ à¤¨à¤¾à¤®, à¤¯à¥‚à¤œà¤°à¤¨à¥‡à¤® à¤”à¤° à¤ªà¤¾à¤¸à¤µà¤°à¥à¤¡ à¤…à¤¨à¤¿à¤µà¤¾à¤°à¥à¤¯ à¤¹à¥ˆ!")
            return
        ...
        QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤µà¥à¤¯à¤µà¤¸à¤¾à¤¯ à¤°à¤œà¤¿à¤¸à¥à¤Ÿà¥à¤°à¥‡à¤¶à¤¨ à¤¸à¤«à¤² à¤°à¤¹à¤¾!")
        self.accept()


# ====================================================================
# 3. à¤®à¥ˆà¤¨à¥à¤…à¤² à¤‘à¤°à¥à¤¡à¤° à¤œà¥‹à¥œà¤¨à¥‡ à¤•à¥‡ à¤²à¤¿à¤ à¤¡à¤¾à¤¯à¤²à¥‰à¤—
# ====================================================================
class AddManualOrderDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        layout.addWidget(QLabel("<b>âž• à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚ à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤ªà¥à¤°à¤¾à¤ªà¥à¤¤ à¤‘à¤°à¥à¤¡à¤° (Manual Entry)</b>", alignment=Qt.AlignmentFlag.AlignCenter))

        self.txt_name = QLineEdit()
        self.txt_name.setPlaceholderText("à¤—à¥à¤°à¤¾à¤¹à¤• à¤•à¤¾ à¤¨à¤¾à¤® (Customer Name)")
        self.txt_phone = QLineEdit()
        self.txt_phone.setPlaceholderText("à¤®à¥‹à¤¬à¤¾à¤‡à¤² à¤¨à¤‚à¤¬à¤° (Mobile Number)")
        self.txt_addr = QLineEdit()
        self.txt_addr.setPlaceholderText("à¤¡à¤¿à¤²à¥€à¤µà¤°à¥€ à¤ªà¤¤à¤¾ (Address)")
        self.txt_items = QLineEdit()
        self.txt_items.setPlaceholderText("à¤†à¤‡à¤Ÿà¤® à¤µà¤¿à¤µà¤°à¤£ à¤µ à¤®à¤¾à¤¤à¥à¤°à¤¾ (à¤‰à¤¦à¤¾. Cadbury x 2)")
        self.txt_total = QLineEdit()
        self.txt_total.setPlaceholderText("à¤•à¥à¤² à¤°à¤¾à¤¶à¤¿ (Total Amount â‚¹)")
        ...
        layout.addWidget(QLabel("Total Amount (â‚¹):"))
    ...
    def save_order(self):
        ...
        if not name or not phone or not items:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤¨à¤¾à¤®, à¤«à¥‹à¤¨ à¤”à¤° à¤†à¤‡à¤Ÿà¤® à¤µà¤¿à¤µà¤°à¤£ à¤…à¤¨à¤¿à¤µà¤¾à¤°à¥à¤¯ à¤¹à¥ˆ!")
            return

        self.db.add_online_order(name, phone, self.txt_addr.text().strip(), items, total, "Online")
        QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤†à¤°à¥à¤¡à¤° à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥‚à¤°à¥à¤µà¤• à¤¦à¤°à¥à¤œ à¤¹à¥‹ à¤—à¤¯à¤¾!")
        self.accept()


# ====================================================================
# 4. à¤…à¤¨à¥à¤¯ à¤ªà¥‰à¤ªà¤…à¤ª à¤¡à¤¾à¤¯à¤²à¥‰à¤—à¥à¤¸
# ====================================================================
class EditProductDialog(QDialog):
    ...
    def save_update(self):
        try:
            ...
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤ªà¥à¤°à¥‹à¤¡à¤•à¥à¤Ÿ à¤…à¤ªà¤¡à¥‡à¤Ÿ à¤¹à¥‹ à¤—à¤¯à¤¾!")
            self.accept()
        except Exception as e:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", str(e))
...
class QuantityDialog(QDialog):
    def __init__(self, item_name, p_unit, s_unit, conv_factor, stock, rate, parent=None):
        ...
        layout.addWidget(QLabel(f"Rate: â‚¹{rate:.2f} | Stock: {stock} {p_unit} (1 {p_unit}={conv_factor} {s_unit})", alignment=Qt.AlignmentFlag.AlignCenter))
        ...
        layout.addWidget(QLabel("à¤®à¤¾à¤¤à¥à¤°à¤¾ à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚:"))
    ...
    def confirm_qty(self):
        try:
            ...
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤¸à¤¹à¥€ à¤®à¤¾à¤¤à¥à¤°à¤¾ à¤­à¤°à¥‡à¤‚!")
...
class LoginDialog(QDialog):
    ...
    def handle_login(self):
        ...
        if user:
            ...
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤—à¤²à¤¤ à¤¯à¥‚à¤œà¤°à¤¨à¥‡à¤® à¤¯à¤¾ à¤ªà¤¾à¤¸à¤µà¤°à¥à¤¡!")
...
class AddCustomerDialog(QDialog):
    def __init__(self, db, pre_phone="", parent=None):
        ...
        layout.addWidget(QLabel("GSTIN (à¤¯à¤¦à¤¿ à¤¹à¥‹):"))
        layout.addWidget(self.txt_gstin)
        layout.addWidget(QLabel("Address (à¤µà¥ˆà¤•à¤²à¥à¤ªà¤¿à¤•):"))
    ...
    def save_cust(self):
        if len(self.txt_phone.text().strip()) < 10 or not self.txt_name.text().strip():
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤®à¥‹à¤¬à¤¾à¤‡à¤² à¤”à¤° à¤¨à¤¾à¤® à¤…à¤¨à¤¿à¤µà¤¾à¤°à¥à¤¯ à¤¹à¥ˆ!")
            return
        try:
            ...
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤—à¥à¤°à¤¾à¤¹à¤• à¤œà¥à¤¡à¤¼ à¤—à¤¯à¤¾!")
            self.accept()
        except Exception as e:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤¯à¤¹ à¤®à¥‹à¤¬à¤¾à¤‡à¤² à¤¨à¤‚à¤¬à¤° à¤ªà¤¹à¤²à¥‡ à¤¸à¥‡ à¤ªà¤‚à¤œà¥€à¤•à¥ƒà¤¤ à¤¹à¥ˆ!")
...
class AddSupplierDialog(QDialog):
    def __init__(self, db, parent=None):
        ...
        layout.addWidget(QLabel("Address (à¤µà¥ˆà¤•à¤²à¥à¤ªà¤¿à¤•):"))
        layout.addWidget(self.txt_address)
        layout.addWidget(QLabel("Opening Balance Due (â‚¹):"))
    ...
    def save_supp(self):
        ...
        try:
            ...
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤¸à¤ªà¥à¤²à¤¾à¤¯à¤° à¤œà¥à¤¡à¤¼ à¤—à¤¯à¤¾!")
            self.accept()
        except Exception as e:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤¸à¤ªà¥à¤²à¤¾à¤¯à¤° à¤ªà¤¹à¤²à¥‡ à¤¸à¥‡ à¤®à¥Œà¤œà¥‚à¤¦ à¤¹à¥ˆ!")
...
class PaymentSettlementDialog(QDialog):
    ...
    def setup_ui(self):
        layout = QVBoxLayout(self)
        self.lbl_net = QLabel(f"<b>NET PAYABLE: â‚¹ {self.final_payable:.2f}</b>", alignment=Qt.AlignmentFlag.AlignCenter)
        self.lbl_net.setFont(QFont("Segoe UI", 14, QFont.Weight.Bold))
        layout.addWidget(self.lbl_net)

        if self.cust_points > 0:
            p_box = QGroupBox(f"Loyalty Points Available: {self.cust_points:.1f} (1 Pt = â‚¹{self.pt_val})")
        ...
        mode_box = QGroupBox("Payment Mode (à¤•à¥€à¤¬à¥‹à¤°à¥à¤¡ à¤¸à¥‡ 1, 2, 3 à¤¦à¤¬à¤¾à¤à¤‚):")
        m_layout = QGridLayout(mode_box)
        self.rb_cash = QRadioButton("1. CASH")
        self.rb_upi = QRadioButton("2. UPI QR")
        self.rb_udhari = QRadioButton("3. UDHARI (à¤‰à¤§à¤¾à¤°)")
        ...
        self.lbl_change = QLabel("Change Due: â‚¹ 0.00")
        ...
        p2 = QWidget()
        l2 = QVBoxLayout(p2)
        l2.addWidget(QLabel("à¤¯à¤¹ à¤¬à¤¿à¤² à¤—à¥à¤°à¤¾à¤¹à¤• à¤•à¥‡ à¤‰à¤§à¤¾à¤° à¤–à¤¾à¤¤à¥‡ à¤®à¥‡à¤‚ à¤¦à¤°à¥à¤œ à¤¹à¥‹ à¤œà¤¾à¤à¤—à¤¾à¥¤", alignment=Qt.AlignmentFlag.AlignCenter))
    ...
    def toggle_redeem(self, state):
        ...
        self.lbl_net.setText(f"<b>NET PAYABLE: â‚¹ {self.final_payable:.2f}</b>")
    ...
    def mode_changed(self, bid):
        if bid == 1:
            ...
            self.selected_mode = "UDHARI (à¤‰à¤§à¤¾à¤°)"
    ...
    def calc_change(self):
        try:
            ...
            self.lbl_change.setText(f"Change Due: â‚¹ {max(0, diff):.2f}")
        except: pass
...
# ====================================================================
# 5. à¤®à¥à¤–à¥à¤¯ à¤¸à¥‰à¤«à¥à¤Ÿà¤µà¥‡à¤¯à¤° (Settings Tab Business Edit & Split Pending/Delivered)
# ====================================================================
class ConfectioneryMasterERP(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.tabs.addTab(self.tab_dash, "ðŸ“Š Dashboard")
        self.tabs.addTab(self.tab_billing, "ðŸ›’ Billing [POS]")
        self.tabs.addTab(self.tab_items, "ðŸ“¦ Item Master & HSN")
        self.tabs.addTab(self.tab_parties, "ðŸ‘¥ Parties (GST / Non-GST)")
        self.tabs.addTab(self.tab_settings, "âš™ï¸ Settings & Masters")
        self.tabs.addTab(self.tab_online_store, "ðŸŒ Online Store & Orders")
        self.tabs.addTab(self.tab_gst_reports, "ðŸ“‘ GST Reports")
        self.tabs.addTab(self.tab_fin_reports, "ðŸ“ˆ P&L & Financial Reports")
        self.tabs.addTab(self.tab_expenses, "ðŸ’¸ Income & Expenses")
    ...
    def init_dashboard_tab(self):
        ...
        title = QLabel(f"ðŸª {self.shop_name} - Dashboard")
        title.setFont(QFont("Segoe UI", 16, QFont.Weight.Bold))
        title.setStyleSheet("color: #005fb8;")
        layout.addWidget(title)

        grid = QGridLayout()
        self.lbl_dash_sales = QLabel("â‚¹ 0.00")
        ...
        grid.addWidget(QLabel("<b>à¤†à¤œ à¤•à¥€ à¤•à¥à¤² à¤¬à¤¿à¤•à¥à¤°à¥€ (Today's Sales):</b>"), 0, 0)
        grid.addWidget(self.lbl_dash_sales, 1, 0)
        grid.addWidget(QLabel("<b>à¤•à¥à¤² à¤ªà¥à¤°à¥‹à¤¡à¤•à¥à¤Ÿà¥à¤¸ (Total Items):</b>"), 0, 1)
        grid.addWidget(self.lbl_dash_prods, 1, 1)
        grid.addWidget(QLabel("<b>ðŸš¨ à¤ªà¥‡à¤‚à¤¡à¤¿à¤‚à¤— à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤‘à¤°à¥à¤¡à¤° (Pending):</b>"), 0, 2)
        grid.addWidget(self.lbl_dash_pending, 1, 2)
        grid.addWidget(QLabel("<b>âœ… à¤¡à¤¿à¤²à¥€à¤µà¤°à¥à¤¡ à¤‘à¤°à¥à¤¡à¤° (Delivered):</b>"), 0, 3)
        grid.addWidget(self.lbl_dash_delivered, 1, 3)

        layout.addLayout(grid)
        layout.addStretch()
        
        btn_refresh = QPushButton("ðŸ”„ Refresh Dashboard")
    ...
    def refresh_dashboard(self):
        ...
        self.lbl_dash_sales.setText(f"â‚¹ {sales:.2f}")
    ...
    def init_billing_tab(self):
        ...
        bot = QHBoxLayout()
        self.lbl_sub = QLabel("Subtotal: â‚¹0.00 | CGST: â‚¹0.00 | SGST: â‚¹0.00")
        self.lbl_tot = QLabel("NET: â‚¹0.00")
    ...
    def check_customer(self):
        ...
        if len(phone) >= 10:
            ...
            if c:
                ...
                self.lbl_c_status.setText(f"{c[1]} ({c[2]}) | Points: {c[3]:.1f} | Due: â‚¹{c[4]:.2f}{gst}")
            else:
    ...
    def handle_scan(self):
        ...
        if prod:
            ...
            if len(matches) == 1:
                ...
                QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤†à¤‡à¤Ÿà¤® à¤¨à¤¹à¥€à¤‚ à¤®à¤¿à¤²à¤¾!")
    ...
    def recalc_bill(self):
        ...
        net = sub + tax_total
        self.lbl_sub.setText(f"Subtotal: â‚¹{sub:.2f} | CGST: â‚¹{cgst:.2f} | SGST: â‚¹{sgst:.2f}")
        self.lbl_tot.setText(f"NET: â‚¹{net:.2f}")
    ...
    def checkout(self):
        ...
        net_amt = float(self.lbl_tot.text().split("â‚¹")[1])
        ...
        if phone != "WALK-IN" and earned > 0:
            ...
            QMessageBox.information(self, "Loyalty Coupon Generated", f"à¤—à¥à¤°à¤¾à¤¹à¤• à¤•à¥‡ à¤²à¤¿à¤ à¤•à¥‚à¤ªà¤¨ à¤œà¥‡à¤¨à¤°à¥‡à¤Ÿ à¤¹à¥à¤†!\nà¤•à¥‚à¤ªà¤¨ à¤•à¥‹à¤¡: {coupon_code}\n(à¤®à¥‚à¤²à¥à¤¯: â‚¹{earned * self.loyalty_point_val:.2f})")
        ...
        try:
            ...
            QMessageBox.warning(self, "à¤ªà¥à¤°à¤¿à¤‚à¤Ÿà¤¿à¤‚à¤— à¤šà¥‡à¤¤à¤¾à¤µà¤¨à¥€", f"à¤¬à¤¿à¤² à¤¸à¥à¤°à¤•à¥à¤·à¤¿à¤¤ à¤¹à¥‹ à¤—à¤¯à¤¾ à¤¹à¥ˆ, à¤²à¥‡à¤•à¤¿à¤¨ à¤ªà¥à¤°à¤¿à¤‚à¤Ÿà¤° à¤à¤°à¤°: {str(e)}")
    ...
    def print_gst_receipt(self, sale_id, time_str, phone, cname, mode, items, sub, cgst, sgst, total, tendered):
        ...
        <div style="font-family: monospace; font-size: 11px; width: 260px;">
            ...
            <hr>
            Subtotal: â‚¹{sub:.2f}<br>CGST: â‚¹{cgst:.2f} | SGST: â‚¹{sgst:.2f}<br>
            <b>GRAND TOTAL: â‚¹{total:.2f}</b><br>
            {"Cash Tendered: â‚¹" + f"{tendered:.2f}<br>Change: â‚¹" + f"{max(0, tendered-total):.2f}" if mode=="CASH" else ""}
            <hr>
    ...
    def init_items_tab(self):
        ...
        btn_edit = QPushButton("âœ Edit Selected Product")
    ...
    def save_new_product(self):
        try:
            ...
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤‰à¤¤à¥à¤ªà¤¾à¤¦ à¤œà¥à¤¡à¤¼ à¤—à¤¯à¤¾!")
            self.load_items_table()
        except Exception as e:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", str(e))
    ...
    def init_parties_tab(self):
        ...
        self.tbl_custs.setHorizontalHeaderLabels(["ID", "Phone", "Name", "Type", "Points", "Due (â‚¹)", "GSTIN"])
        ...
        self.tbl_supps.setHorizontalHeaderLabels(["ID", "Name", "Phone", "Type", "GSTIN", "Pending (â‚¹)"])
    ...
    def init_settings_tab(self):
        ...
        biz_box = QGroupBox("ðŸª Business Profile Settings (à¤µà¥à¤¯à¤¾à¤ªà¤¾à¤° à¤µà¤¿à¤µà¤°à¤£ à¤à¤¡à¤¿à¤Ÿ à¤•à¤°à¥‡à¤‚)")
        ...
        btn_save_biz = QPushButton("ðŸ’¾ Update Business Details")
        ...
        loy_l.addWidget(QLabel("1 Point Value (â‚¹):"), 0, 2)
    ...
    def save_business_profile_edits(self):
        try:
            ...
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤¬à¤¿à¤œà¤¨à¥‡à¤¸ à¤ªà¥à¤°à¥‹à¤«à¤¾à¤‡à¤² à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥‚à¤°à¥à¤µà¤• à¤…à¤ªà¤¡à¥‡à¤Ÿ à¤¹à¥‹ à¤—à¤ˆ!")
        except Exception as e:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", str(e))
    ...
    def save_new_category(self):
        ...
        try:
            ...
            QMessageBox.information(self, "à¤¸à¤«à¤²", f"à¤•à¥ˆà¤Ÿà¥‡à¤—à¤°à¥€ '{name}' ({sub}) à¤œà¥à¤¡à¤¼ à¤—à¤ˆ!")
    ...
    def save_loyalty_settings(self):
        try:
            ...
            self.load_config()
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤²à¥‰à¤¯à¤²à¥à¤Ÿà¥€ à¤ªà¥‰à¤‡à¤‚à¤Ÿà¥à¤¸ à¤¸à¥‡à¤Ÿà¤¿à¤‚à¤—à¥à¤¸ à¤…à¤ªà¤¡à¥‡à¤Ÿ à¤¹à¥‹ à¤—à¤ˆ!")
        except ValueError:
            QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", "à¤•à¥ƒà¤ªà¤¯à¤¾ à¤¸à¤¹à¥€ à¤¸à¤‚à¤–à¥à¤¯à¤¾à¤¤à¥à¤®à¤• à¤®à¤¾à¤¨ (Numbers) à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚!")
    ...
    def init_online_store_tab(self):
        ...
        layout.addWidget(QLabel("<b>ðŸŒ ONLINE STORE & CUSTOMER ORDERS MANAGEMENT</b>", font=QFont("Segoe UI", 14, QFont.Weight.Bold)))
        
        h_box = QHBoxLayout()
        
        link_box = QGroupBox("Online Store Link & Export")
        link_l = QVBoxLayout(link_box)
        link_l.addWidget(QLabel("à¤†à¤ª à¤¨à¥€à¤šà¥‡ à¤¦à¤¿à¤ à¤—à¤ à¤²à¤¿à¤‚à¤• à¤•à¥‹ Netlify à¤ªà¤° à¤…à¤ªà¤²à¥‹à¤¡ à¤•à¤° à¤¸à¤•à¤¤à¥‡ à¤¹à¥ˆà¤‚:"))
        self.txt_store_link = QLineEdit(f"https://{self.shop_name.lower().replace(' ', '')}.netlify.app")
        self.txt_store_link.setReadOnly(True)
        
        btn_copy = QPushButton("Export Online Store HTML (à¤®à¤¾à¤¤à¥à¤°à¤¾ à¤šà¤¯à¤¨ à¤•à¥‡ à¤¸à¤¾à¤¥)")
        ...
        coup_box = QGroupBox("Verify & Apply Customer Coupon (à¤•à¥‚à¤ªà¤¨ à¤œà¤¾à¤‚à¤šà¥‡à¤‚)")
        coup_l = QVBoxLayout(coup_box)
        self.txt_coupon_input = QLineEdit(placeholderText="Enter Coupon Code (à¤‰à¤¦à¤¾. COUPON-ABC123)")
        ...
        self.lbl_coup_result = QLabel("à¤•à¥‚à¤ªà¤¨ à¤•à¥€ à¤¸à¥à¤¥à¤¿à¤¤à¤¿...")
        ...
        # Pending Orders Box
        pend_box = QGroupBox("â³ Pending Orders (à¤²à¤‚à¤¬à¤¿à¤¤ à¤‘à¤°à¥à¤¡à¤°)")
        ...
        btn_mark_del = QPushButton("âœ… Mark as Delivered (à¤¡à¤¿à¤²à¥€à¤µà¤°à¥à¤¡ à¤•à¤°à¥‡à¤‚)")
        ...
        del_box = QGroupBox("âœ… Delivered Orders (à¤ªà¥‚à¤°à¥à¤£ à¤‘à¤°à¥à¤¡à¤°)")
        ...
        btn_refresh_ord = QPushButton("ðŸ”„ Refresh Orders")
        ...
        btn_bar = QHBoxLayout()
        btn_add_manual = QPushButton("+ Add Online Order (à¤®à¥ˆà¤¨à¥à¤…à¤² à¤†à¤°à¥à¤¡à¤° à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚)")
        ...
        btn_wa_notify = QPushButton("ðŸ’¬ WhatsApp à¤ªà¤° à¤†à¤°à¥à¤¡à¤° à¤­à¥‡à¤œà¥‡à¤‚")
    ...
    CLOUD_API_BASE = "https://ravi-pos.onrender.com"
    ...
    def sync_online_orders_from_cloud(self, silent=True):
        ...
        try:
            if not CLOUD_API_KEY:
                if not silent:
                    QMessageBox.warning(
                        self,
                        "Online Sync",
                        "RAVI_POS_API_KEY Windows environment variable à¤¨à¤¹à¥€à¤‚ à¤®à¤¿à¤²à¤¾à¥¤"
                    )
                return 0
            ...
            if added:
                self.load_online_orders()
                self.refresh_dashboard()
                self.statusBar().showMessage(f"{added} à¤¨à¤¯à¤¾ online order à¤ªà¥à¤°à¤¾à¤ªà¥à¤¤ à¤¹à¥à¤†", 8000)
            elif not silent:
                QMessageBox.information(self, "Online Orders", "à¤•à¥‹à¤ˆ à¤¨à¤¯à¤¾ online order à¤¨à¤¹à¥€à¤‚ à¤®à¤¿à¤²à¤¾à¥¤")
            return added
        except Exception as e:
            print("Cloud order sync error:", e)
            if not silent:
                QMessageBox.warning(self, "Online Sync", f"Online Store à¤¸à¥‡ connection à¤¨à¤¹à¥€à¤‚ à¤¹à¥‹ à¤ªà¤¾à¤¯à¤¾à¥¤\n\n{e}")
            return 0
    ...
    def sync_products_to_cloud(self, silent=True):
        """Push the complete local product list to Render.
        Products with stock <= 0 are treated as inactive for the online store.
        This also sends zero/negative-stock products so Cloud can hide products
        that were previously available.
        """
        try:
            if not CLOUD_API_KEY:
                if not silent:
                    QMessageBox.warning(self, "Product Sync", "RAVI_POS_API_KEY Windows environment variable à¤¨à¤¹à¥€à¤‚ à¤®à¤¿à¤²à¤¾à¥¤")
                return 0

            products = []
            for r in self.db.get_all_products():
                stock = float(r[11] or 0)
                products.append({
                    "id": int(r[0]),
                    "barcode": r[1] or "",
                    "name": r[2] or "",
                    ...
                    "sub_category": r[4] or "",
                    "primary_unit": r[6] or "BOX",
                    "secondary_unit": r[7] or "PCS",
                    "conversion_factor": float(r[8] or 1),
                    "sale_rate": float(r[10] or 0),
                    "stock": stock,
                    "gst_rate": float(r[12] or 0),
                    "active": stock > 0
                })

            url = self.CLOUD_API_BASE.rstrip("/") + "/api/products/sync"
            ...
            req = urllib.request.Request(
                ...
                headers={
                    ...
                    "User-Agent": "Ravi-Confectionery-POS/1.0",
            ...
            if payload.get("status") != "success":
                raise RuntimeError(payload.get("message", "Cloud product sync failed"))

            if not silent:
                QMessageBox.information(self, "Product Sync", f"{payload.get('count', 0)} products Cloud à¤ªà¤° sync à¤¹à¥‹ à¤—à¤à¥¤")
            return int(payload.get("count", 0))
        except Exception as e:
            print("Cloud product sync error:", e)
            if not silent:
                QMessageBox.warning(self, "Product Sync", f"Products Cloud à¤ªà¤° sync à¤¨à¤¹à¥€à¤‚ à¤¹à¥‹ à¤ªà¤¾à¤à¥¤\n\n{e}")
            return 0
    ...
    def start_online_order_sync(self):
        ...
        self.online_sync_timer.timeout.connect(lambda: self.sync_products_to_cloud(True))
        self.online_sync_timer.start(15000)
        QTimer.singleShot(1500, lambda: self.sync_online_orders_from_cloud(True))
        QTimer.singleShot(2500, lambda: self.sync_products_to_cloud(True))
    ...
    def load_online_orders(self):
        ...
        try:
            ...
            for i, r in enumerate(pend_rows):
                ...
                vals = [str(r[0]), r[1], r[2], r[3], f"{r[4]} (â‚¹{r[5]:.2f})", "Deliver"]
        ...
        try:
            ...
            for i, r in enumerate(del_rows):
                ...
                vals = [str(r[0]), r[1], r[2], r[3], f"{r[4]} (â‚¹{r[5]:.2f})", "Delivered"]
                for c, val in enumerate(vals):
    ...
    def change_order_status(self, new_status):
        ...
        if row < 0:
            QMessageBox.warning(self, "à¤šà¤¯à¤¨ à¤•à¤°à¥‡à¤‚", "à¤•à¥ƒà¤ªà¤¯à¤¾ à¤ªà¥‡à¤‚à¤¡à¤¿à¤‚à¤— à¤¸à¥‚à¤šà¥€ à¤¸à¥‡ à¤•à¥‹à¤ˆ à¤‘à¤°à¥à¤¡à¤° à¤šà¥à¤¨à¥‡à¤‚!")
            return
        ...
        QMessageBox.information(self, "à¤¸à¤«à¤²", f"à¤‘à¤°à¥à¤¡à¤° #{order_id} à¤•à¥‹ 'Delivered' à¤®à¤¾à¤°à¥à¤• à¤•à¤° à¤¦à¤¿à¤¯à¤¾ à¤—à¤¯à¤¾ à¤¹à¥ˆ!")
        self.load_online_orders()
    ...
    def send_order_to_whatsapp(self):
        ...
        if row < 0:
            ...
            if row < 0:
                QMessageBox.warning(self, "à¤šà¤¯à¤¨ à¤•à¤°à¥‡à¤‚", "à¤•à¥ƒà¤ªà¤¯à¤¾ à¤•à¤¿à¤¸à¥€ à¤­à¥€ à¤¸à¥‚à¤šà¥€ à¤¸à¥‡ à¤•à¥‹à¤ˆ à¤‘à¤°à¥à¤¡à¤° à¤šà¥à¤¨à¥‡à¤‚!")
                return
        ...
        msg = f"ðŸ“¦ *à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤‘à¤°à¥à¤¡à¤° à¤µà¤¿à¤µà¤°à¤£*\n\n*à¤—à¥à¤°à¤¾à¤¹à¤•:* {c_name}\n*à¤®à¥‹à¤¬à¤¾à¤‡à¤²:* {c_phone}\n*à¤†à¤‡à¤Ÿà¤®:* {c_items}"
    ...
    def export_online_store_html(self):
        ...
        for it in items:
            ...
            <div style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; margin: 10px; width: 220px; display: inline-block; background: white; text-align: center; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                ...
                <p style="color: #107c41; font-weight: bold; font-size: 16px;">â‚¹ {it[2]:.2f} / {it[4]}</p>
                <p style="color: gray; font-size: 12px;">à¤‰à¤ªà¤²à¤¬à¥à¤§ à¤¸à¥à¤Ÿà¥‰à¤•: {it[3]} {it[4]}</p>
        ...
        <body>
            ...
            <div id="checkoutModal" class="modal">
                <div class="modal-content">
                    ...
                    <h3>ðŸ›ï¸ Complete Your Order</h3>
                    <p id="prodInfo" style="font-weight: bold; color: #0078d4;"></p>
                    <label>à¤®à¤¾à¤¤à¥à¤°à¤¾ (Quantity):</label>
                    <input type="number" id="prodQty" value="1" min="1" oninput="calcTotal()" style="font-weight:bold;">
                    <input type="text" id="custName" placeholder="à¤†à¤ªà¤•à¤¾ à¤ªà¥‚à¤°à¤¾ à¤¨à¤¾à¤® (Full Name)" required>
                    <input type="text" id="custPhone" placeholder="à¤®à¥‹à¤¬à¤¾à¤‡à¤² à¤¨à¤‚à¤¬à¤° (Mobile Number)" required>
                    <textarea id="custAddr" placeholder="à¤ªà¥‚à¤°à¤¾ à¤¡à¤¿à¤²à¥€à¤µà¤°à¥€ à¤ªà¤¤à¤¾ (Delivery Address)" style="height:60px;" required></textarea>
                    <input type="text" id="couponCode" placeholder="à¤•à¥‚à¤ªà¤¨ à¤•à¥‹à¤¡ (à¤¯à¤¦à¤¿ à¤¹à¥‹ à¤¤à¥‹ à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚)">
                    <select id="payMode">
                        <option value="UPI">UPI QR Payment</option>
                        <option value="COD">Cash on Delivery (COD)</option>
                    </select>
                    <p id="totalDisplay" style="font-weight:bold; color:#107c41; text-align:center; font-size:16px;"></p>
                    <button class="btn" onclick="submitOrderToWhatsApp()">ðŸ’¬ Send Order via WhatsApp</button>
                </div>
            </div>
            ...
            <script>
                ...
                function openCheckout(name, price, unit) {{
                    ...
                    document.getElementById("prodInfo").innerText = selectedProduct + " - â‚¹" + price + " / " + unitName;
                    calcTotal();
                ...
                function calcTotal() {{
                    ...
                    document.getElementById("totalDisplay").innerText = "Total Payable: â‚¹ " + tot.toFixed(2);
                }}
                ...
                function submitOrderToWhatsApp() {{
                    ...
                    if(!name || !phone || !addr) {{
                        alert("à¤•à¥ƒà¤ªà¤¯à¤¾ à¤¨à¤¾à¤®, à¤®à¥‹à¤¬à¤¾à¤‡à¤² à¤¨à¤‚à¤¬à¤° à¤”à¤° à¤ªà¤¤à¤¾ à¤…à¤µà¤¶à¥à¤¯ à¤­à¤°à¥‡à¤‚!");
                        return;
                    }}

                    let orderSummary = selectedProduct + " x " + qty + " " + unitName;

                    // à¤‘à¤Ÿà¥‹à¤®à¥ˆà¤Ÿà¤¿à¤• à¤¡à¥‡à¤Ÿà¤¾à¤¬à¥‡à¤¸ à¤¸à¤¿à¤‚à¤• à¤•à¥‡ à¤²à¤¿à¤ à¤à¤¨à¤—à¥à¤°à¥‹à¤• à¤²à¤¿à¤‚à¤• (cÃ´de à¤®à¥‡à¤‚ à¤‡à¤¨à¤¬à¤¿à¤²à¥à¤Ÿ)
                    let apiURL = "https://ravi-pos.onrender.com/api/save_order";
                    ...
                    let msg = "ðŸ“¦ *à¤¨à¤¯à¤¾ à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤‘à¤°à¥à¤¡à¤° à¤ªà¥à¤°à¤¾à¤ªà¥à¤¤ à¤¹à¥à¤†!*\\n\\n" +
                              "*à¤—à¥à¤°à¤¾à¤¹à¤• à¤•à¤¾ à¤¨à¤¾à¤®:* " + name + "\\n" +
                              "*à¤®à¥‹à¤¬à¤¾à¤‡à¤² à¤¨à¤‚à¤¬à¤°:* " + phone + "\\n" +
                              "*à¤¡à¤¿à¤²à¥€à¤µà¤°à¥€ à¤ªà¤¤à¤¾:* " + addr + "\\n" +
                              "*à¤†à¤‡à¤Ÿà¤® à¤µà¤¿à¤µà¤°à¤£:* " + orderSummary + "\\n" +
                              "*à¤•à¥‚à¤ªà¤¨ à¤•à¥‹à¤¡:* " + (coupon ? coupon : "à¤²à¤¾à¤—à¥‚ à¤¨à¤¹à¥€à¤‚") + "\\n" +
                              "*à¤•à¥à¤² à¤°à¤¾à¤¶à¤¿:* â‚¹" + tot.toFixed(2) + "\\n" +
                              "*à¤­à¥à¤—à¤¤à¤¾à¤¨ à¤•à¤¾ à¤¤à¤°à¥€à¤•à¤¾:* " + mode;
        ...
        if path:
            with open(path, "w", encoding="utf-8") as f:
                f.write(store_html)
            QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤¨à¤¯à¤¾ à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤¸à¥à¤Ÿà¥‹à¤° à¤à¤•à¥à¤¸à¤ªà¥‹à¤°à¥à¤Ÿ à¤¹à¥‹ à¤—à¤¯à¤¾ à¤¹à¥ˆ! à¤‡à¤¸à¥‡ Netlify à¤ªà¤° à¤¦à¥‹à¤¬à¤¾à¤°à¤¾ à¤¡à¥à¤°à¥ˆà¤—-à¤à¤‚à¤¡-à¤¡à¥à¤°à¥‰à¤ª à¤•à¤°à¤•à¥‡ à¤…à¤ªà¤¡à¥‡à¤Ÿ à¤•à¤° à¤¦à¥‡à¤‚à¥¤")
    ...
    def init_gst_reports_tab(self):
        ...
        btn_csv_gst = QPushButton("ðŸ“¥ Export GST Report (CSV)")
        ...
        self.lbl_gst_out = QLabel("à¤®à¤¾à¤¸à¤¿à¤• GSTR à¤¸à¤®à¤°à¥€ à¤¦à¥‡à¤–à¤¨à¥‡ à¤•à¥‡ à¤²à¤¿à¤ à¤¤à¤¾à¤°à¥€à¤– à¤šà¥à¤¨à¤•à¤° 'Generate' à¤¦à¤¬à¤¾à¤à¤‚...")
...
================================================================================
 1. à¤•à¥à¤² à¤‡à¤¨à¤µà¥‰à¤‡à¤¸ à¤¸à¤‚à¤–à¥à¤¯à¤¾ (Total Bills)      : {cnt}
 2. à¤•à¥à¤² à¤Ÿà¥ˆà¤•à¥à¤¸à¥‡à¤¬à¤² à¤µà¥ˆà¤²à¥à¤¯à¥‚ (Taxable Value)   : â‚¹ {sub:.2f}
 3. à¤•à¥à¤² à¤†à¤‰à¤Ÿà¤ªà¥à¤Ÿ CGST (Output CGST)        : â‚¹ {cgst:.2f}
 4. à¤•à¥à¤² à¤†à¤‰à¤Ÿà¤ªà¥à¤Ÿ SGST (Output SGST)        : â‚¹ {sgst:.2f}
 5. à¤•à¥à¤² à¤œà¥€à¤à¤¸à¤Ÿà¥€ à¤¦à¥‡à¤¯à¤¤à¤¾ (Total Tax Liability): â‚¹ {(cgst + sgst):.2f}
 6. à¤•à¥à¤² à¤•à¤° à¤¸à¤¹à¤¿à¤¤ à¤¬à¤¿à¤•à¥à¤°à¥€ (Gross Turnover)   : â‚¹ {tot:.2f}
================================================================================
        """
    ...
    def init_fin_reports_tab(self):
        ...
        self.cmb_fin_type.addItems([
            "Daily Report (à¤¦à¥ˆà¤¨à¤¿à¤• à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ)", 
            "Monthly Report (à¤®à¤¾à¤¸à¤¿à¤• à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ)", 
            "Yearly Report (à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ)", 
            "Profit & Loss Statement (à¤²à¤¾à¤­-à¤¹à¤¾à¤¨à¤¿ à¤–à¤¾à¤¤à¤¾)", 
            "Balance Sheet (à¤¬à¥ˆà¤²à¥‡à¤‚à¤¸ à¤¶à¥€à¤Ÿ)",
            "Stock Valuation (à¤¸à¥à¤Ÿà¥‰à¤• à¤µà¥ˆà¤²à¥à¤¯à¥‚à¤à¤¶à¤¨)"
        ])
        ...
        btn_csv_fin = QPushButton("ðŸ“¥ Export to Excel (CSV)")
        ...
        self.lbl_fin_out = QLabel("à¤«à¤¾à¤‡à¤¨à¥‡à¤‚à¤¶à¤¿à¤¯à¤² à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ à¤¦à¥‡à¤–à¤¨à¥‡ à¤•à¥‡ à¤²à¤¿à¤ à¤µà¤¿à¤•à¤²à¥à¤ª à¤šà¥à¤¨à¥‡à¤‚...")
...
================================================================================
 1. à¤•à¥à¤² à¤¬à¤¿à¤²à¥‹à¤‚ à¤•à¥€ à¤¸à¤‚à¤–à¥à¤¯à¤¾            : {cnt}
 2. à¤Ÿà¥ˆà¤•à¥à¤¸à¥‡à¤¬à¤² à¤¬à¤¿à¤•à¥à¤°à¥€                : â‚¹ {sub:.2f}
 3. à¤œà¥€à¤à¤¸à¤Ÿà¥€ à¤•à¤²à¥‡à¤•à¥à¤Ÿà¥‡à¤¡                : â‚¹ {tax:.2f}
 4. à¤•à¥à¤² à¤¬à¤¿à¤•à¥à¤°à¥€ (Gross Revenue)    : â‚¹ {tot:.2f}
 5. à¤•à¥à¤² à¤¦à¥à¤•à¤¾à¤¨ à¤–à¤°à¥à¤šà¥‡                : â‚¹ {exp:.2f}
 6. à¤¶à¥à¤¦à¥à¤§ à¤®à¥à¤¨à¤¾à¤«à¤¾ (Net Profit)      : â‚¹ {(prof - exp):.2f}
================================================================================
            """
...
================================================================================
 1. à¤•à¥à¤² à¤®à¤¾à¤¸à¤¿à¤• à¤¬à¤¿à¤²                : {cnt}
 2. à¤Ÿà¥ˆà¤•à¥à¤¸à¥‡à¤¬à¤² à¤µà¥ˆà¤²à¥à¤¯à¥‚               : â‚¹ {sub:.2f}
 3. à¤•à¥à¤² à¤œà¥€à¤à¤¸à¤Ÿà¥€                   : â‚¹ {tax:.2f}
 4. à¤•à¥à¤² à¤Ÿà¤°à¥à¤¨à¤“à¤µà¤°                  : â‚¹ {tot:.2f}
 5. à¤•à¥à¤² à¤®à¤¾à¤¸à¤¿à¤• à¤–à¤°à¥à¤šà¥‡                : â‚¹ {exp:.2f}
 6. à¤¶à¥à¤¦à¥à¤§ à¤®à¥à¤¨à¤¾à¤«à¤¾                  : â‚¹ {(prof - exp):.2f}
================================================================================
            """
            self.lbl_fin_out.setText(txt)
...
================================================================================
 1. à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤•à¥à¤² à¤¬à¤¿à¤²               : {cnt}
 2. à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤Ÿà¥ˆà¤•à¥à¤¸à¥‡à¤¬à¤² à¤µà¥ˆà¤²à¥à¤¯à¥‚        : â‚¹ {sub:.2f}
 3. à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤œà¥€à¤à¤¸à¤Ÿà¥€                : â‚¹ {tax:.2f}
 4. à¤•à¥à¤² à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤Ÿà¤°à¥à¤¨à¤“à¤µà¤°          : â‚¹ {tot:.2f}
 5. à¤•à¥à¤² à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤–à¤°à¥à¤šà¥‡              : â‚¹ {exp:.2f}
 6. à¤µà¤¾à¤°à¥à¤·à¤¿à¤• à¤¶à¥à¤¦à¥à¤§ à¤®à¥à¤¨à¤¾à¤«à¤¾          : â‚¹ {(prof - exp):.2f}
================================================================================
            """
            self.lbl_fin_out.setText(txt)
            ...
            txt = f"""
================================================================================
                      PROFIT & LOSS STATEMENT (à¤²à¤¾à¤­ à¤”à¤° à¤¹à¤¾à¤¨à¤¿)
================================================================================
 [INCOME / à¤†à¤¯ à¤ªà¤•à¥à¤·]
   - à¤¸à¤•à¤² à¤µà¥à¤¯à¤¾à¤ªà¤¾à¤°à¤¿à¤• à¤²à¤¾à¤­ (Gross Profit) : â‚¹ {gross_prof:.2f}
   - à¤…à¤¨à¥à¤¯ à¤†à¤¯ (Other Income)          : â‚¹ {other_inc:.2f}
   -----------------------------------------------------------------------------
   TOTAL INCOME                       : â‚¹ {(gross_prof + other_inc):.2f}

 [EXPENSES / à¤µà¥à¤¯à¤¯ à¤ªà¤•à¥à¤·]
   - à¤•à¥à¤² à¤¦à¥à¤•à¤¾à¤¨ à¤µ à¤¸à¤‚à¤šà¤¾à¤²à¤¨ à¤–à¤°à¥à¤šà¥‡          : â‚¹ {total_exp:.2f}
   -----------------------------------------------------------------------------
   TOTAL EXPENSES                     : â‚¹ {total_exp:.2f}

 ===============================================================================
   NET PROFIT (à¤¶à¥à¤¦à¥à¤§ à¤²à¤¾à¤­)             : â‚¹ {net_prof:.2f}
================================================================================
            """
            self.lbl_fin_out.setText(txt)
            ...
            txt = f"""
================================================================================
                      BALANCE SHEET (à¤†à¤°à¥à¤¥à¤¿à¤• à¤¸à¥à¤¥à¤¿à¤¤à¤¿)
================================================================================
 [ASSETS / à¤¸à¤‚à¤ªà¤¤à¥à¤¤à¤¿ à¤ªà¤•à¥à¤·]
   - à¤•à¥à¤²à¥‹à¤œà¤¿à¤‚à¤— à¤¸à¥à¤Ÿà¥‰à¤• à¤µà¥ˆà¤²à¥à¤¯à¥‚ (Stock Value) : â‚¹ {stock_val:.2f}
   - à¤—à¥à¤°à¤¾à¤¹à¤•à¥‹à¤‚ à¤¸à¥‡ à¤²à¥‡à¤¨à¤¾ à¤¬à¤¾à¤•à¥€ (Customer Due)  : â‚¹ {cust_due:.2f}
   -----------------------------------------------------------------------------
   TOTAL ASSETS                         : â‚¹ {(stock_val + cust_due):.2f}

 [LIABILITIES / à¤¦à¥‡à¤¯à¤¤à¤¾ à¤ªà¤•à¥à¤·]
   - à¤¸à¤ªà¥à¤²à¤¾à¤¯à¤° à¤•à¥‹ à¤¦à¥‡à¤¨à¤¾ à¤¬à¤¾à¤•à¥€ (Supplier Due) : â‚¹ {supp_due:.2f}
   -----------------------------------------------------------------------------
   TOTAL LIABILITIES                    : â‚¹ {supp_due:.2f}
================================================================================
            """
            self.lbl_fin_out.setText(txt)
...
================================================================================
 1. à¤¸à¥à¤Ÿà¥‰à¤• à¤•à¥€ à¤•à¥à¤² à¤–à¤°à¥€à¤¦ à¤®à¥‚à¤²à¥à¤¯ (Investment Value) : â‚¹ {(b_val or 0):.2f}
 2. à¤¸à¥à¤Ÿà¥‰à¤• à¤•à¥€ à¤•à¥à¤² à¤¬à¤¿à¤•à¥à¤°à¥€ à¤®à¥‚à¤²à¥à¤¯ (Market Value)   : â‚¹ {(s_val or 0):.2f}
 3. à¤¸à¤‚à¤­à¤¾à¤µà¤¿à¤¤ à¤²à¤¾à¤­ (Potential Profit)             : â‚¹ {((s_val or 0) - (b_val or 0)):.2f}
================================================================================
            """
            self.lbl_fin_out.setText(txt)
    ...
    def init_expenses_tab(self):
        ...
        self.cmb_exp_type.addItems(["EXPENSE (à¤–à¤°à¥à¤šà¤¾)", "INCOME (à¤…à¤¨à¥à¤¯ à¤†à¤¯)"])
        self.cmb_exp_cat = QComboBox()
        self.cmb_exp_cat.addItems(["à¤¦à¥à¤•à¤¾à¤¨ à¤•à¤¿à¤°à¤¾à¤¯à¤¾", "à¤¬à¤¿à¤œà¤²à¥€ à¤¬à¤¿à¤²", "à¤¸à¥à¤Ÿà¤¾à¤« à¤µà¥‡à¤¤à¤¨", "à¤šà¤¾à¤¯-à¤¨à¤¾à¤¶à¥à¤¤à¤¾", "à¤ªà¤°à¤¿à¤µà¤¹à¤¨/à¤­à¤¾à¤¡à¤¼à¤¾", "à¤…à¤¨à¥à¤¯"])
        self.txt_exp_amt = QLineEdit()
        self.txt_exp_amt.setPlaceholderText("à¤°à¤•à¤® (â‚¹)")
        self.txt_exp_rem = QLineEdit()
        self.txt_exp_rem.setPlaceholderText("à¤µà¤¿à¤µà¤°à¤£ (Remark)")
        ...
        self.exp_table.setHorizontalHeaderLabels(["ID", "Date", "Type", "Category", "Amount (â‚¹)"])
    ...
    def export_csv_generic(self, content_text, filename):
        ...
        if path:
            try:
                ...
                QMessageBox.information(self, "à¤¸à¤«à¤²", "à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥‚à¤°à¥à¤µà¤• Excel (CSV) à¤®à¥‡à¤‚ à¤¸à¥‡à¤µ à¤¹à¥‹ à¤—à¤ˆ!")
            except Exception as e:
                QMessageBox.warning(self, "à¤¤à¥à¤°à¥à¤Ÿà¤¿", str(e))
...
if __name__ == "__main__":
    # 1. à¤¬à¥ˆà¤•à¤—à¥à¤°à¤¾à¤‰à¤‚à¤¡ à¤®à¥‡à¤‚ Flask API à¤¸à¤°à¥à¤µà¤° à¤¶à¥à¤°à¥‚ à¤•à¤°à¥‡à¤‚
    server_thread = threading.Thread(target=run_flask_server, daemon=True)
    server_thread.start()

    # 2. PyQt6 Desktop Application à¤¶à¥à¤°à¥‚ à¤•à¤°à¥‡à¤‚
